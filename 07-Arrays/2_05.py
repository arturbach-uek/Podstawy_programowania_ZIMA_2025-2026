...
def seats_total(cinema_seats):
    return sum(1 for row in cinema_seats for _ in row)

def seats_available(cinema_seats):
   return sum(seat == "A" for row in cinema_seats for seat in row)

def seats_booked(cinema_seats):
   return sum(seat == "B" for row in cinema_seats for seat in row)
